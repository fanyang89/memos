...
func (x *SearchMemosRequest) GetTopK() int32 {
	if x != nil {
		return x.TopK
	}
	return 0
...
func (x *SearchMemosResponse) GetResults() []*SearchResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *SearchResult) GetMemo() string {
	if x != nil {
		return x.Memo
	}
	return ""
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"\x14BatchGetLinkMetadata\x12).memos.api.v1.BatchGetLinkMetadataRequest\x1a*.memos.api.v1.BatchGetLinkMetadataResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/api/v1/memos/-/linkMetadata:batchGet\x12{\n" +
	"\vSearchMemos\x12 .memos.api.v1.SearchMemosRequest\x1a!.memos.api.v1.SearchMemosResponse\"'\xdaA\x05query\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/api/v1/memos:searchB\xa8\x01\n" +
...
var file_api_v1_memo_service_proto_goTypes = []any{
	...
	(*SearchMemosRequest)(nil),           // 35: memos.api.v1.SearchMemosRequest
	(*SearchMemosResponse)(nil),          // 36: memos.api.v1.SearchMemosResponse
	(*SearchResult)(nil),                 // 37: memos.api.v1.SearchResult
...
var file_api_v1_memo_service_proto_depIdxs = []int32{
	...
	37, // 31: memos.api.v1.SearchMemosResponse.results:type_name -> memos.api.v1.SearchResult
	...
	30, // 49: memos.api.v1.MemoService.GetMemoByShare:input_type -> memos.api.v1.GetMemoByShareRequest
	...
	35, // 52: memos.api.v1.MemoService.SearchMemos:input_type -> memos.api.v1.SearchMemosRequest
	...
	44, // 57: memos.api.v1.MemoService.DeleteMemo:output_type -> google.protobuf.Empty
	44, // 58: memos.api.v1.MemoService.SetMemoAttachments:output_type -> google.protobuf.Empty
	13, // 59: memos.api.v1.MemoService.ListMemoAttachments:output_type -> memos.api.v1.ListMemoAttachmentsResponse
	44, // 60: memos.api.v1.MemoService.SetMemoRelations:output_type -> google.protobuf.Empty
	...
	44, // 66: memos.api.v1.MemoService.DeleteMemoReaction:output_type -> google.protobuf.Empty
	...
	44, // 69: memos.api.v1.MemoService.DeleteMemoShare:output_type -> google.protobuf.Empty
	3,  // 70: memos.api.v1.MemoService.GetMemoByShare:output_type -> memos.api.v1.Memo
	...
	36, // 73: memos.api.v1.MemoService.SearchMemos:output_type -> memos.api.v1.SearchMemosResponse
