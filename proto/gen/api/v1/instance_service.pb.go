...
type InstanceSetting_AISetting struct {
	...
	ImageSearch   *InstanceSetting_ImageSearchConfig `protobuf:"bytes,4,opt,name=image_search,json=imageSearch,proto3" json:"image_search,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InstanceSetting_AISetting) GetImageSearch() *InstanceSetting_ImageSearchConfig {
	if x != nil {
...
type InstanceSetting_ImageSearchConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// provider_id references an entry in AISetting.providers[].id.
...
func (x *InstanceSetting_ImageSearchConfig) Reset() {
	*x = InstanceSetting_ImageSearchConfig{}
	mi := &file_api_v1_instance_service_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InstanceSetting_ImageSearchConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InstanceSetting_ImageSearchConfig) ProtoMessage() {}

func (x *InstanceSetting_ImageSearchConfig) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InstanceSetting_ImageSearchConfig.ProtoReflect.Descriptor instead.
func (*InstanceSetting_ImageSearchConfig) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{2, 10}
}

func (x *InstanceSetting_ImageSearchConfig) GetProviderId() string {
	if x != nil {
		return x.ProviderId
	}
	return ""
...
func (x *InstanceSetting_ImageSearchConfig) GetVisionModel() string {
	if x != nil {
...
func (x *InstanceSetting_ImageSearchConfig) GetPrompt() string {
	if x != nil {
		return x.Prompt
	}
	return ""
...
const file_api_v1_instance_service_proto_rawDesc = "" +
	...
	"\x19GetInstanceProfileRequest\"\xa9\x1e\n" +
	...
	"\tembedding\x18\x03 \x01(\v2-.memos.api.v1.InstanceSetting.EmbeddingConfigR\tembedding\x12R\n" +
	"\fimage_search\x18\x04 \x01(\v2/.memos.api.v1.InstanceSetting.ImageSearchConfigR\vimageSearch\x1a\x80\x02\n" +
...
var file_api_v1_instance_service_proto_goTypes = []any{
	...
	(*InstanceSetting_ImageSearchConfig)(nil),            // 23: memos.api.v1.InstanceSetting.ImageSearchConfig
	(*InstanceSetting_GeneralSetting_CustomProfile)(nil), // 24: memos.api.v1.InstanceSetting.GeneralSetting.CustomProfile
	...
	(*InstanceSetting_NotificationSetting_EmailSetting)(nil), // 27: memos.api.v1.InstanceSetting.NotificationSetting.EmailSetting
	(*InstanceStats_DatabaseStats)(nil),                      // 28: memos.api.v1.InstanceStats.DatabaseStats
...
var file_api_v1_instance_service_proto_depIdxs = []int32{
	...
	27, // 10: memos.api.v1.TestInstanceEmailSettingRequest.email:type_name -> memos.api.v1.InstanceSetting.NotificationSetting.EmailSetting
	28, // 11: memos.api.v1.InstanceStats.database:type_name -> memos.api.v1.InstanceStats.DatabaseStats
	31, // 12: memos.api.v1.InstanceStats.generated_time:type_name -> google.protobuf.Timestamp
	24, // 13: memos.api.v1.InstanceSetting.GeneralSetting.custom_profile:type_name -> memos.api.v1.InstanceSetting.GeneralSetting.CustomProfile
	...
	25, // 15: memos.api.v1.InstanceSetting.StorageSetting.s3_config:type_name -> memos.api.v1.InstanceSetting.StorageSetting.S3Config
	32, // 16: memos.api.v1.InstanceSetting.TagMetadata.background_color:type_name -> google.type.Color
	26, // 17: memos.api.v1.InstanceSetting.TagsSetting.tags:type_name -> memos.api.v1.InstanceSetting.TagsSetting.TagsEntry
	27, // 18: memos.api.v1.InstanceSetting.NotificationSetting.email:type_name -> memos.api.v1.InstanceSetting.NotificationSetting.EmailSetting
	...
	23, // 22: memos.api.v1.InstanceSetting.AISetting.image_search:type_name -> memos.api.v1.InstanceSetting.ImageSearchConfig
	...
	33, // 35: memos.api.v1.InstanceService.TestInstanceEmailSetting:output_type -> google.protobuf.Empty
