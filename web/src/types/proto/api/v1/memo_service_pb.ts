...
export type SearchMemosRequest = Message<"memos.api.v1.SearchMemosRequest"> & {
  ...
  /**
   * Optional. A CEL filter to scope the search (same syntax as ListMemos.filter).
   * Applied as a post-filter on the SQL store after vector retrieval.
   *
